...
// http错误
var (
	ErrBadRequest   = NewServerError(http.StatusBadRequest)
	ErrUnauthorized = NewServerError(http.StatusUnauthorized)
	ErrForbidden    = NewServerError(http.StatusForbidden)
