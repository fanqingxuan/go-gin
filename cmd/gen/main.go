// Model 代码生成器
// 用法: go run cmd/gen/main.go -f .env
//       go run cmd/gen/main.go -f .env -t user,order,product
// 自动扫描数据库所有表，生成 entity/do/dao 三层代码
package main
...
const entityTmpl = `// Code generated by cmd/gen. DO NOT EDIT.
package entity
...
const doTmpl = `// Code generated by cmd/gen. DO NOT EDIT.
package do
...
const daoInternalTmpl = `// Code generated by cmd/gen. DO NOT EDIT.
package internal
...
const daoTmpl = `// Code generated by cmd/gen. You may modify this file.
package dao
