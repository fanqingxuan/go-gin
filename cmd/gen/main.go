// 枚举代码生成器
// 用法: go run cmd/gen/main.go
// 自动扫描 const/enum 目录下所有嵌入 etype.BaseEnum 的结构体，生成对应的 _gen.go 文件
package main
...
const tmpl = `// Code generated by cmd/gen. DO NOT EDIT.
package {{.Package}}
...
func main() {
	...
	for _, e := range enums {
		fileName := filepath.Join(e.Dir, toSnakeCase(e.Type)+"_gen.go")
